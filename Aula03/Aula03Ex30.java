...
public class Aula03Ex30 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Digite o preco do protudo: ");
		preco = ler.nextDouble();
		
		System.out.printf("Opcoes de pagamento:\n ");
		...
		switch(opc) {
			case 1:
				...
				System.out.printf("O total a ser pago e de: %.2f.", aPagar);
				break;
